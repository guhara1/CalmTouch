...
const raw = [
  ...
  // ---- 계양·제물포 (수요 있는 원도심권, 각 지역 고유 성격 반영) ----
  {
    slug: "gyesan-jakjeon", region: "incheon", regionLabel: "인천",
    title: "계산·작전 생활권 안내｜계양구 방문 전 확인 · 간다GO",
    description: "계산·작전 주거·상권과 부천·서울 강서 인접권 방문 전 확인 안내.",
    h1: "계산·작전 생활권 안내",
    keywords: ["계산 출장마사지", "작전동 홈타이", "인천 계양구 생활권"],
    overview: "계산과 작전은 인천 계양구의 주거·상업 중심 생활권으로, 인천1호선 계산역·작전역을 낀 원도심과 아파트 단지가 함께 있는 지역입니다. 계양구청·계양산 일대의 생활 인프라가 밀집해 있고, 계양신도시(3기 신도시) 조성으로 변화가 이어지는 지역이라 최신 도로명 주소와 단지명 확인이 좋습니다.",
    parentNote: "행정구역상 계양구에 속하며, 계산역·작전역·임학역 등 인천1호선 역세권과 함께 확인하기 좋습니다.",
    lifeNote: "계산·작전은 부천 원종·고강과 서울 강서 사이의 인접 이동권에 있어, 방문 위치가 어느 도시 경계에 가까운지 확인이 필요합니다. 계양신도시 조성 구역은 신축 단지가 순차적으로 들어섭니다.",
    nearbyNote: "가까운 역은 계산역·작전역이며, 부천 방향으로는 원종·고강 연결 생활권과 이어집니다.",
    useNote: "계산·작전은 다세대 주택과 아파트 단지가 섞여 있어, 정확한 도로명 주소와 공동현관 출입 방식 확인이 중요한 생활권입니다.",
    links: [{ title: "인천·연결 생활권", items: [
      { label: "원종·고강 연결 생활권 보기", url: "/corridor/wonjong-gogang/" },
      { label: "작전역 주변 확인", url: "/station/jakjeon-station/" },
      { label: "계산역 주변 확인", url: "/station/gyesan-station/" }
    ]}]
  },
  {
    slug: "jemulpo-dongincheon", region: "incheon", regionLabel: "인천",
    title: "제물포·동인천 생활권 안내｜제물포권 방문 전 확인 · 간다GO",
    description: "제물포·동인천 원도심·개항장권 방문 전 주소·출입 확인을 안내합니다.",
    h1: "제물포·동인천 생활권 안내",
    keywords: ["제물포 출장마사지", "동인천 홈타이", "인천 원도심 생활권"],
    overview: "제물포와 동인천 일대는 인천의 대표 원도심 생활권으로, 1호선 제물포역·동인천역을 중심으로 오래된 상권과 주택가, 개항장 근대 거리가 함께 있는 지역입니다. 골목이 촘촘하고 노후 주택과 신축 건물이 섞여 있어, 정확한 위치와 건물 출입 방식을 먼저 확인하는 것이 특히 중요합니다.",
    parentNote: "인천 행정체제 개편에 따라 제물포구의 명칭과 관할 구역이 조정될 수 있어, 방문 시 확정 고시된 최신 행정구역 기준으로 확인합니다. 제물포역·동인천역·도원역 등 1호선 역세권과 함께 확인하기 좋습니다.",
    lifeNote: "제물포·동인천은 미추홀 주안·도화 생활권과 이어지고, 중구 개항장·신포동 방향과도 가깝습니다. 원도심 특성상 골목·다세대 주소 확인이 중요합니다.",
    nearbyNote: "가까운 역은 제물포역·동인천역이며, 주안 방향으로는 주안·도화 생활권과 이어집니다.",
    useNote: "제물포·동인천은 노후 주택과 상가가 많아, 정확한 도로명 주소와 공동현관·건물 출입 방식 확인이 특히 중요한 생활권입니다.",
    links: [{ title: "인천 생활권", items: [
      { label: "주안·도화 생활권 안내", url: "/incheon/life/juan-dohwa/" },
      { label: "제물포역 주변 확인", url: "/station/jemulpo-station/" },
      { label: "동인천역 주변 확인", url: "/station/dongincheon-station/" }
    ]}]
  }
];
